...
| HU-07             | Como usuario, quiero que el módulo de pulso cardíaco registre y muestre mis niveles de pulso. | Puede     | 2                  | Comprobar que el pulso se muestra en la pantalla. | Andres Arredondo   |
...
| HU-10             | Como usuario, quiero que el buzzer emita un sonido de advertencia cuando se detecten problemas. | Quizás    | 1                  | Comprobar que el buzzer suena durante una alarma. | Jonatan Raciel     |
| HU-11             | Como usuario, quiero que el sensor de movimiento adicional se integre al sistema de seguridad. | Quizás    | 1                  | Verificar que el sensor adicional activa la alarma. | Jonatan Raciel     |
